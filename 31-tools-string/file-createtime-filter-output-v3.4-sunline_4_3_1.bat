@echo off
d: 
cd D:\81-micro-dos\31-tools-string\sunline_3.1\
for /f "delims==" %%i in ('dir  /b /s  *.jar') do (
	...
	move %%i.class.pkg D:\81-micro-dos\31-tools-string\sunline_jar_3.1_class
	move %%i.java.pkg D:\81-micro-dos\31-tools-string\sunline_jar_3.1_java
)
pause
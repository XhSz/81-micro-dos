@echo off
d: 
cd D:\03-sl\325-jocom\24-dev\2\package-class\ct-dist-3.1.2.7-BNC-RELEASE\lib
for /f "delims==" %%i in ('dir  /b /s  *.jar') do (
	...
	move %%i.class.pkg D:\03-sl\325-jocom\24-dev\2\package\ct-22-class
	move %%i.java.pkg D:\03-sl\325-jocom\24-dev\2\package\ct-23-java
)
pause
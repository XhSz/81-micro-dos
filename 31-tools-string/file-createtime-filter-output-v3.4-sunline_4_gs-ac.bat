@echo off
d: 
cd D:\03-sl\326-gs\24-dev\35-gl\gl-dist\lib\1
for /f "delims==" %%i in ('dir  /b /s  *.jar') do (
	...
	move %%i.class.pkg D:\03-sl\326-gs\24-dev\35-gl\gl-dist\lib\ac-class
	move %%i.java.pkg D:\03-sl\326-gs\24-dev\35-gl\gl-dist\lib\ac-java
)
pause
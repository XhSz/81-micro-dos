...
// Source File Name:   AppcTcpWithPkgHeader.java
...
public class AppcTcpWithPkgHeader extends cn.sunline.adp.cedar.busi.sdk.component.AppcCompImpl.AppcTcp
    implements cn.sunline.adp.cedar.busi.sdk.component.BaseComp.Appc
{

    public AppcTcpWithPkgHeader()
    {
    }
        ...
        throws EdspServiceException
    {
        ...
        {
            log.error(cn.sunline.adp.cedar.busi.sdk.constant.BusiSDKConstantDef.SPC_BS.C013(), e, new Object[0]);
        }
        return s;
        Exception exception;
        exception;
    ...
    private static final SysLog log = SysLogUtil.getSysLog(cn/sunline/adp/cedar/busi/sdk/service/appc/AppcTcpWithPkgHeader);

...
public interface KSysSequenceDefineTable
{
    ...
    public static class Tsp_sequence_registerDao
    {
        ...
        private static final IString tsp_sequence_register_table_name = new IString("KSysSequenceDefineTable.tsp_sequence_register.longname", "\u6D41\u6C34\u6CE8\u518C\u8868");


        public Tsp_sequence_registerDao()
        {
        }
    }

    public static interface tsp_sequence_register
    {
        public static class odb2
            implements cn.sunline.adp.metadata.model.annotation.Index.Name
        {
        ...
        public abstract String getService_code();

        public abstract void setService_code(String s);
    ...
    public static class Tsp_sequence_defineDao
    {

        public static int insert(tsp_sequence_define entity)
            throws AdpDaoException, AdpDaoDuplicateException, AdpDaoLockException
        {
            try
            {
                return DaoUtil.insert(cn/sunline/adp/cedar/base/tables/KSysSequenceDefineTable$tsp_sequence_define, entity);
            }
            catch(AdpDaoDuplicateException e1)
            {
                throw new AdpDaoDuplicateException(new IString(cn.sunline.adp.core.exception.InternationalConstantDef.SPC_IN.C011, (new Params()).add("tableName", tsp_sequence_define_table_name)), e1);
            }
            catch(AdpDaoLockException e2)
            {
                throw new AdpDaoLockException(new IString(cn.sunline.adp.core.exception.InternationalConstantDef.SPC_IN.C005, (new Params()).add("tableName", tsp_sequence_define_table_name)), e2);
            }
            catch(AdpDaoException e3)
            {
                throw new AdpDaoException(new IString(cn.sunline.adp.core.exception.InternationalConstantDef.SPC_IN.C001, (new Params()).add("tableName", tsp_sequence_define_table_name)), e3);
            }
        }

        public static int insertWithReturnKey(tsp_sequence_define entity)
            throws AdpDaoException, AdpDaoDuplicateException, AdpDaoLockException
        {
            try
            {
                return DaoUtil.insertWithReturnKey(cn/sunline/adp/cedar/base/tables/KSysSequenceDefineTable$tsp_sequence_define, entity);
            }
            catch(AdpDaoDuplicateException e1)
            {
                throw new AdpDaoDuplicateException(new IString(cn.sunline.adp.core.exception.InternationalConstantDef.SPC_IN.C011, (new Params()).add("tableName", tsp_sequence_define_table_name)), e1);
        ...
        public static tsp_sequence_define selectOne_id(String serial_code, String system_code, String corporate_code, boolean nullException)
            throws AdpDaoNoDataFoundException, AdpDaoLockException, AdpDaoTooManyRowsException
        {
            Params parms = (new Params()).add("serial_code", serial_code).add("system_code", system_code).add("corporate_code", corporate_code);
            try
            {
                return (tsp_sequence_define)DaoUtil.selectOneByIndex(cn/sunline/adp/cedar/base/tables/KSysSequenceDefineTable$tsp_sequence_define, cn/sunline/adp/cedar/base/tables/KSysSequenceDefineTable$tsp_sequence_define$id, nullException, parms);
            }
            catch(AdpDaoNoDataFoundException e1)
            {
                throw new AdpDaoNoDataFoundException(new IString(cn.sunline.adp.core.exception.InternationalConstantDef.SPC_IN.C010, (new Params()).add("tableName", tsp_sequence_define_table_name)), e1);
            }
            catch(AdpDaoTooManyRowsException e2)
            {
                throw new AdpDaoTooManyRowsException(new IString(cn.sunline.adp.core.exception.InternationalConstantDef.SPC_IN.C018, (new Params()).add("tableName", tsp_sequence_define_table_name)), e2);
            }
            catch(AdpDaoLockException e3)
            {
                throw new AdpDaoLockException(new IString(cn.sunline.adp.core.exception.InternationalConstantDef.SPC_IN.C008, (new Params()).add("tableName", tsp_sequence_define_table_name)), e3);
            }
            catch(AdpDaoException e4)
            {
                throw new AdpDaoException(new IString(cn.sunline.adp.core.exception.InternationalConstantDef.SPC_IN.C004, (new Params()).add("tableName", tsp_sequence_define_table_name)), e4);
            }
        }

        public static int updateOne_id(tsp_sequence_define entity)
            throws AdpDaoNoDataFoundException, AdpDaoLockException, AdpDaoTooManyRowsException
        {
            try
            {
                return DaoUtil.updateOneByIndex(cn/sunline/adp/cedar/base/tables/KSysSequenceDefineTable$tsp_sequence_define, cn/sunline/adp/cedar/base/tables/KSysSequenceDefineTable$tsp_sequence_define$id, entity);
            }
            catch(AdpDaoNoDataFoundException e1)
            {
                throw new AdpDaoNoDataFoundException(new IString(cn.sunline.adp.core.exception.InternationalConstantDef.SPC_IN.C009, (new Params()).add("tableName", tsp_sequence_define_table_name)), e1);
            }
            catch(AdpDaoTooManyRowsException e2)
            {
                throw new AdpDaoTooManyRowsException(new IString(cn.sunline.adp.core.exception.InternationalConstantDef.SPC_IN.C019, (new Params()).add("tableName", tsp_sequence_define_table_name)), e2);
            }
            catch(AdpDaoLockException e3)
            {
                throw new AdpDaoLockException(new IString(cn.sunline.adp.core.exception.InternationalConstantDef.SPC_IN.C007, (new Params()).add("tableName", tsp_sequence_define_table_name)), e3);
            }
            catch(AdpDaoException e4)
            {
                throw new AdpDaoException(new IString(cn.sunline.adp.core.exception.InternationalConstantDef.SPC_IN.C003, (new Params()).add("tableName", tsp_sequence_define_table_name)), e4);
            }
        }

        public static tsp_sequence_define selectOneWithLock_id(String serial_code, String system_code, String corporate_code, boolean nullException)
            throws AdpDaoNoDataFoundException, AdpDaoLockException, AdpDaoTooManyRowsException
        {
            Params parms = (new Params()).add("serial_code", serial_code).add("system_code", system_code).add("corporate_code", corporate_code);
            try
            {
                return (tsp_sequence_define)DaoUtil.selectOneWithLockByIndex(cn/sunline/adp/cedar/base/tables/KSysSequenceDefineTable$tsp_sequence_define, cn/sunline/adp/cedar/base/tables/KSysSequenceDefineTable$tsp_sequence_define$id, nullException, parms);
            }
            catch(AdpDaoNoDataFoundException e1)
            {
                throw new AdpDaoNoDataFoundException(new IString(cn.sunline.adp.core.exception.InternationalConstantDef.SPC_IN.C010, (new Params()).add("tableName", tsp_sequence_define_table_name)), e1);
        ...
        private static final IString tsp_sequence_define_table_name = new IString("KSysSequenceDefineTable.tsp_sequence_define.longname", "\u6D41\u6C34\u5B9A\u4E49\u8868");


        public Tsp_sequence_defineDao()
        {
        }
    }

    public static interface tsp_sequence_define
    {
        public static class id extends cn.sunline.adp.metadata.model.annotation.Index.PrimaryKey
        {
        ...
        public abstract String getSerial_code();

        public abstract void setSerial_code(String s);

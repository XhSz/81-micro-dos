...
// Source File Name:   RpcNettyChannelInitializer.java
...
//            RpcNettyHandler, RpcServer

public class RpcNettyChannelInitializer extends ChannelInitializer
{

    public RpcNettyChannelInitializer(RpcServer server)
    {
        this.server = server;
    }
        ...
        throws Exception
    {
        ...
        pipeline.addLast("handler", new RpcNettyHandler(server));
    }

@echo off
d: 
cd D:\03-sl\325-jocom\24-dev\2\package-class\marketing-dist-3.1.2.12-BNC-RELEASE-2\lib
for /f "delims==" %%i in ('dir  /b /s  *.jar') do (
	...
	move %%i.class.pkg D:\03-sl\325-jocom\24-dev\2\package\mk-22-class-2
	move %%i.java.pkg D:\03-sl\325-jocom\24-dev\2\package\mk-23-java-2
)
pause